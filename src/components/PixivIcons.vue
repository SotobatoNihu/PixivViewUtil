<template>
  <img
      v-if="icon === 'like'"
      src="https://s.pximg.net/www/js/spa/260127df5fe9ade778ec4be463deaf01.svg"
       width="12"
       height="12">
  <svg
    ...
    <path
        fill="currentColor"
        d="M9,0.75 C10.6568542,0.75 12,2.09314575 12,3.75 C12,6.68851315 10.0811423,9.22726429 6.24342696,11.3662534
  ...
  <img
      v-else-if="icon === 'view'"
      src="https://s.pximg.net/www/js/spa/af74d092363c09fd06441a4ab04c9331.svg"
       width="14"
       height="12">
